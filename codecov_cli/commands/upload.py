...
_global_upload_options = [
    ...
    click.option(
        "--test-file",
        "--testing-result-files-search-direct-file",
        "test_result_files_search_explicitly_listed_files",
        help="Testing result file to upload. This will be added to the testing result files found to be uploaded. Only the testing result files specified by this option will be uploaded. If you wish to only upload the specified testing result files, please consider using --disable-search to disable uploading automatically searched for files.",
        type=click.Path(path_type=pathlib.Path),
        multiple=True,
        default=[],
    ),
    ...
    click.option(
        "--disable-test-search",
        help="Disable search for testing result files. This is helpful when specifying what testing result files you want to upload with the --test-file option.",
        is_flag=True,
        default=False,
    ),
    click.option(
...
def do_upload(
    ...
    test_result_files_search_explicitly_listed_files: typing.List[pathlib.Path],
    disable_search: bool,
    disable_test_search: bool,
    ...
    logger.debug(
        ...
        extra=dict(
            extra_log_attributes=dict(
                ...
                test_result_files_search_explicitly_listed_files=test_result_files_search_explicitly_listed_files,
