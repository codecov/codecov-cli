...
class PatchCoverageService(object):
    ...
    def run_patch_coverage_command(self, staged: bool, diff_base: str) -> None:
        ...
        if all_uncovered_lines:
            ...
            click.echo(f"{len(all_uncovered_lines)} Uncovered lines ☝️")
        else:
            click.echo("No uncovered lines :)")
        ...
        if total_lines_coverable:
            ...
            click.echo("Could not find any coverable lines in the git diff")
