...
def test_upload_process_options(mocker):
    ...
    with runner.isolated_filesystem():
        ...
        assert result.output.split("\n")[1:] == [
            ...
            "  --test-file, --testing-result-files-search-direct-file PATH",
            "                                  Testing result file to upload. This will be",
            "                                  added to the testing result files found to be",
            "                                  uploaded. Only the testing result files",
            "                                  specified by this option will be uploaded. If",
            "                                  you wish to only upload the specified testing",
            "                                  result files, please consider using --disable-",
            "                                  search to disable uploading automatically",
            "                                  searched for files.",
            ...
            "  --disable-test-search           Disable search for testing result files. This",
            "                                  is helpful when specifying what testing result",
            "                                  files you want to upload with the --test-file",
            "                                  option.",
