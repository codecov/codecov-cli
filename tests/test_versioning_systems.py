...
class TestGitVersioningSystem(object):
    def test_list_relevant_files_throws_exception_if_network_root_cant_be_determined(self, mocker):
    ...
    def test_list_relevant_files_returns_correct_network_files(self, mocker):
        ...
        mocker.patch("codecov_cli.helpers.versioning_systems.subprocess.run", return_value=mocked_subprocess)
